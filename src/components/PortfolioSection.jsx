...
const projects = [
  ...
  { id: 41, title: '안전한 바다를 만드는 보안 기술 [메사쿠어컴퍼니]', category: 'Campaigns', videoId: 'vd8XsU0EBQM' },
  { id: 42, title: '화물차주-운송사-화주사 매칭 플랫폼 [코코넛사일로]', category: 'Campaigns', videoId: '8nzFxmatrRU' },
  { id: 43, title: '세계 최초! 바닷속 식물로 만든 신소재 [다인바이오]', category: 'Campaigns', videoId: 'OR-NBoQqXXg' },
  { id: 44, title: '세계 최초! 알아서 선명해지는 유리 [마이크로시스템]', category: 'Campaigns', videoId: 'KrMCnN7bzG0' },
  ...
  { id: 51, title: '제11기 해리포터 기자단 발대식 현장', category: 'Campaigns', videoId: 'PJiSXZSm80I' },
